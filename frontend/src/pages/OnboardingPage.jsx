...
import { Camera, LoaderIcon, MapPinIcon, MessageSquare, ShuffleIcon } from "lucide-react";
        ...
        <div className="card-body p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col items-center justify-center space-y-4">
              {/* IMAGE PREVIEW */}
              <div className="size-32 rounded-full bg-base-300 overflow-hidden ring-4 ring-primary ring-offset-2 ring-offset-base-200">
              ...
              <div className="flex items-center gap-2">
                <button type="button" onClick={handleRandomAvatar} className="btn btn-outline btn-primary btn-sm rounded-full">
